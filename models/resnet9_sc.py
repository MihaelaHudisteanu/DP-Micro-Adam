...
def conv_gn_act(in_channels, out_channels, pool=False, act_func=nn.Mish, num_groups=16):
...
def resnet9_sc(num_classes=10, act_func=nn.Mish):
    """ResNet9 with BatchNorm"""
    return ResNet9(
    in_channels=3,
    num_classes=num_classes,
    act_func=act_func,
    scale_norm=True,           # add ScaleNorm after residual blocks
    norm_layer="group",
