...
# from sparse_transfer.utils.datasets import aircraft_get_datasets, birds_get_datasets, \
#     caltech101_get_datasets, caltech256_get_datasets, \
#     cars_get_datasets, dtd_get_datasets,\
#     flowers_get_datasets, food101_get_datasets, \
#     pets_get_datasets, SUN_get_datasets

# from lib.data.augmented_datasets import get_augmented_pets, get_augmented_birds, get_augmented_aircraft

_DATASETS = [
    'cifar10', 'cifar10_fine', 'cifar100', 'cifar100_fine', 'mnist',
...
def get_cifar10_no_aug_datasets(data_dir):
    train_transform = transforms.Compose([
        transforms.ToTensor(),
        transforms.Normalize(mean=_CIFAR10_RGB_MEANS, std=_CIFAR10_RGB_STDS)
    ])
...
def get_cifar10_fine_datasets(data_dir):
    train_transform = transforms.Compose([
...
def get_cifar100_fine_datasets(data_dir):
    train_transform = transforms.Compose([
        transforms.Resize(224),           
        transforms.RandomCrop(224, padding=4),
        transforms.RandomHorizontalFlip(),
...
def get_imagenette_datasets(data_dir):
...
def get_imagewoof_datasets(data_dir):
...
def get_datasets(dataset, dataset_dir):
    ...
    if f'get_{dataset}_datasets' in globals():
        return globals()[f'get_{dataset}_datasets'](dataset_dir) # example: get_cifar10_datasets
    return globals()[f'{dataset}_get_datasets'](dataset_dir) # example: cifar10_get_datasets


# def get_augmented_datasets(args, dataset, dataset_dir):
#     return globals()[f'get_augmented_{dataset}'](dataset_dir, args)
